...
function openSocial(type) {
  ...
  switch (type) {
    case 'discord':
      url = 'https://discord.gg/37BQnsP3UW';
      break;
    case 'zeqa':
      url = 'https://discord.gg/zeqa';
      break;
  }
...
function startIntroTyping() {
  new TypeIt('#intro-text', {
    ...
    .type(`${mobile ? 'tap' : 'press any key'} to enter. (also koruze was here)`)
    .go();
...
function typerStartTyping(typer) {
  ...
  let text = ['Discord Server','Make', 'Sure', 'To', 'Boost'];
